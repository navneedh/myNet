...
def neuralNet():
    ...
    l1 = tf.nn.sigmoid(tf.matmul(x,weights['W1']) + biases['B1'])
...
#regWeights =
regTerm = 5
cost = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=result, labels=y_)) / 10
...
with tf.Session() as sess:
    ...
    print("Testing Accuracy:", totalCorrect/2000)
